...
$string['allcertificatesgenerated'] = '{$a->issuedcerts} certificates were issued to all students with completed status. {$a->notissued} students alredy have certificates.';
$string['allcertificatesgeneratedall'] = '{$a->issuedcerts} certificates were issued to all students. {$a->notissued} students alredy have certificates.';
$string['allcertificatesgeneratedselected'] = '{$a->issuedcerts} certificates were issued to selected students. {$a->notissued} students alredy have certificates.';
