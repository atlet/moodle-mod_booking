...
$string['allcertificatesgenerated'] = '{$a} certificates were issued to all students with completed status.';
$string['allcertificatesgeneratedall'] = '{$a} certificates were issued to all students.';
$string['allcertificatesgeneratedselected'] = '{$a} certificates were issued to all selected students.';
