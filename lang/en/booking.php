...
$string['alloptionsdeleted'] = 'All selected options were successfully deleted.';
...
$string['unlimitedmpu'] = 'Number of completion satuses is not limited';
...
$string['maxconfirmations'] = 'Max completions per user';
$string['maxperuser_help'] = 'The maximum number of bookings an individual user can make in this activity at once.';
$string['maxconfirmations_help'] = 'The maximum number of completions an individual user can have in this activity at once.';
$string['maxperuseronlyactive'] = 'Count user only in active bookings';
$string['maxperuseronlyactive_help'] = 'If yes is selected after an event end time has passed, it is no longer counted against this limit.';
...
$string['selectatleastoneoption'] = 'Please, select at least 1 option!';
...
$string['deleteselectedoptions'] = "Delete selected options";