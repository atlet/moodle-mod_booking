...
$ADMIN->add(
    ...
    new admin_category(
        'modbookingfolder',
        new lang_string('pluginname', 'mod_booking'),
...
if ($ADMIN->fulltree) {
    ...
    if ($proversion) {
        ...
        $settings->add(
            new admin_setting_configcheckbox(
                ...
                get_string('bookingplacesinfotexts_info', 'booking'),
                0
            )
        );
        ...
        $settings->add(
            new admin_setting_configcheckbox(
                ...
                get_string('waitinglistinfotexts_info', 'booking'),
                0
            )
        );
    ...
    $settings->add(
        new admin_setting_configcheckbox(
            ...
            get_string('attachicalsessdesc', 'mod_booking'),
            1
        )
    );
    $settings->add(
    ...
    $options = array(
        1 => get_string('courseurl', 'mod_booking'), 2 => get_string('location', 'mod_booking'),
    ...
    $settings->add(
        new admin_setting_heading(
            'mod_booking_headmasterreport',
            get_string('headmasterheader', 'mod_booking'),
            get_string('headmasterheader_desc', 'mod_booking')
        )
    );
    ...
    $settings->add(
        new admin_setting_configselect(
            'booking/hmrfield',
            get_string('customprofilefield', 'booking'),
            '',
            '',
            $cfields
        )
    ...
    $name = 'booking/hmrvalue';
    $visiblename = get_string('customprofilefieldvalue', 'booking');
    $description = '';
    $setting = new admin_setting_configtext($name, $visiblename, $description, '');
    $settings->add($setting);
}
